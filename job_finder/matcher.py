...
SYSTEM_PROMPT = (
    ...
    "HARD REQUIREMENT (applies first, overrides everything else): only KEEP roles "
    "that are new-grad / entry-level or require 0-2 years of experience. "
    "DROP the job (keep=false) if it is targeted at more senior candidates, e.g. "
    "titled Senior/Staff/Principal/Lead/Mgr, or the qualifications require more than "
    "2 years of professional experience. If experience is unstated, assume it fits. "
    "If the role passes that requirement, KEEP the job if ANY of these is true: "
